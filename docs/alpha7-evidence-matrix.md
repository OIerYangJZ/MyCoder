...
| Requirement                                               | Status         | Evidence | Notes                                                                                                                         |
| --------------------------------------------------------- | -------------- | -------- | ----------------------------------------------------------------------------------------------------------------------------- |
| Strict public-address egress on a clean resolver (§39–41) | NOT TESTED     |          | both hosts sit behind a transparent fake-IP resolver; see `docs/alpha7-status.md` for the measurement and what would close it |
