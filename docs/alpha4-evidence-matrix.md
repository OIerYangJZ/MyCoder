...
| grandchild budget attribution at depth>1 | NOT TESTED     |          | Records are flat at the root, so a grandchild would charge the root's turn. Conservative, and unreachable at the default depth of 1 (ADR-0013)           |
